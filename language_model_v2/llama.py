...
class LlamaHypers:
    ...
    lora: int|None = 8
    lora_modules: list[str] = default(['embed_tokens', 'q_proj', 'k_proj', 'v_proj', 'o_proj', 'gate_proj', 'up_proj', 'down_proj', 'lm_head'])
...
prompt['input_ids'].to('cuda')
prompt['attention_mask'].to('cuda')
